...
<body>
    <nav class="navBar">
        <ul>
            ...
            <li><a href="../SoftwareQuality/SQ.php" class="active">SQ</a></li>
    ...
    <div>
        <h1 class="mainTitle">Portfolio Software Quality</h1>
    </div>
    <main>
        ...
        <div>
            <h1 class="NSYMessage">&#40;NSY&#41;: Will be available  in year 2 period 3!</h1>
        </div>
    </main>
</body>
