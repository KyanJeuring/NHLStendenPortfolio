...
<body>
    <nav class="navBar">
        <ul>
            ...
            <li><a href="../AppDev/AppDev.php" class="active">AppDev</a></li>
            <li><a href="../Projects/Projects.html">Projects</a></li>
            <li><a href="../ProfessionalSkills/PS.html">PS</a></li>
        </ul>
    </nav>
    <div>
        <h1 class="mainTitle">Portfolio AppDev</h1>
    </div>
    <main>
        ...
        <div>
            <h1 class="NSYMessage">&#40;NSY&#41;: Will be available  in year 2 period 4!</h1>
        </div>
    </main>
</body>
